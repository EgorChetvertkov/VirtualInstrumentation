...
namespace VirtualInstrumentation.Model
{
    internal class Instrument : IModel
    {
        ...
        public void Start(double w0, double w1, double w2, double w3, double w4, double w5)
        {
            ...
            _x0Filter = new Filter(0.99999999, _x0Generator.CurrentValue);
            _x1Filter = new Filter(0.99999999, _x1Generator.CurrentValue);
            _x2Filter = new Filter(0.99999999, _x2Generator.CurrentValue);

            _function.UpdateWs(w0, w1, w2, w3, w4, w5);
            _yFilter = new Filter(0.99999999,
